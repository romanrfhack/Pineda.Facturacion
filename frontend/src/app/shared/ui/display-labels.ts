...
const DISPLAY_LABELS: Record<string, string> = {
  ...
  DiscardedUnstamped: 'Descartado localmente',
  CancellationRequested: 'Cancelación solicitada',
  Cancelled: 'Cancelado',
  CancellationRejected: 'Cancelación rechazada',
  LocalDiscard: 'Descarte local',
  ProviderCancellation: 'Cancelación PAC/SAT',
  ...
  Internal: 'Interno',
  External: 'Externo',
  ReadyForNextPhase: 'Listo para siguiente fase',
  ReadyForPayment: 'Listo para pago',
  ReadyForRepPreparation: 'Listo para preparar REP',
  ReadyForRepStamping: 'Listo para timbrar REP',
  RepIssued: 'REP emitido',
  ViewDetail: 'Ver detalle',
  OpenInternalWorkflow: 'Operar interno',
  RegisterPayment: 'Registrar pago',
  PrepareRep: 'Preparar REP',
  StampRep: 'Timbrar REP',
  RefreshRepStatus: 'Refrescar estatus REP',
  CancelRep: 'Cancelar REP',
  NoAction: 'Sin acción',
  PendingStamp: 'Pendientes de timbrar',
  WithError: 'Con error',
  AppliedPaymentWithoutStampedRep: 'Pago aplicado sin REP',
  PendingRefresh: 'Pendientes de refresh',
  ...
  DuplicateExternalInvoice: 'Factura externa duplicada',
  AppliedPaymentsWithoutStampedRep: 'Pago aplicado sin REP timbrado',
  PreparedRepPendingStamp: 'REP preparado pendiente',
  RepStampingRejected: 'REP rechazado',
  RepCancellationRejected: 'Cancelación REP rechazada',
  StampedRepAvailable: 'REP timbrado disponible',
  Yes: 'Sí',
  No: 'No',
  None: 'Ninguno',
  Unknown: 'Desconocido'
