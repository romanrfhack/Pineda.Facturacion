...
@Component({
  ...
  template: `
    <section class="panel">
      ...
      @if (stamp().supportMessage) {
        <p class="helper">{{ stamp().supportMessage }}</p>
      }
      <div class="actions">
