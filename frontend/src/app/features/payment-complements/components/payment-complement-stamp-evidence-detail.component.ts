...
@Component({
  selector: 'app-payment-complement-stamp-evidence-detail',
  imports: [DatePipe],
  template: `
    <section class="panel">
      <div class="header">
        <div>
          <p class="eyebrow">Complement stamp detail</p>
...
export class PaymentComplementStampEvidenceDetailComponent {
