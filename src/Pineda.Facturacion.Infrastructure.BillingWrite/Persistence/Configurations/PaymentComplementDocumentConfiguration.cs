...
public class PaymentComplementDocumentConfiguration : IEntityTypeConfiguration<PaymentComplementDocument>
{
    public void Configure(EntityTypeBuilder<PaymentComplementDocument> builder)
    {
        builder.ToTable("payment_complement_document");
        ...
        builder.Property(x => x.TotalPaymentsAmount)
