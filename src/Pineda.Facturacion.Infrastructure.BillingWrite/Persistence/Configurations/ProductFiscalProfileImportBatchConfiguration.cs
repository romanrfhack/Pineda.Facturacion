...
public class ProductFiscalProfileImportBatchConfiguration : IEntityTypeConfiguration<ProductFiscalProfileImportBatch>
{
    public void Configure(EntityTypeBuilder<ProductFiscalProfileImportBatch> builder)
    {
        builder.ToTable("product_fiscal_profile_import_batch");
        ...
        builder.Property(x => x.DefaultTaxObjectCode)
