        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var paymentComplements = await (
            ...
            select new ExternalRepBaseDocumentPaymentComplementReadModel
            {
                ...
                StampCreatedAtUtc = paymentComplementStamp != null ? paymentComplementStamp.CreatedAtUtc : null,
                StampUpdatedAtUtc = paymentComplementStamp != null ? paymentComplementStamp.UpdatedAtUtc : null,
                StampedAtUtc = paymentComplementStamp != null ? paymentComplementStamp.StampedAtUtc : null,
                LastStatusCheckAtUtc = paymentComplementStamp != null ? paymentComplementStamp.LastStatusCheckAtUtc : null,
                LastKnownExternalStatus = paymentComplementStamp != null ? paymentComplementStamp.LastKnownExternalStatus : null,
                LastStatusProviderCode = paymentComplementStamp != null ? paymentComplementStamp.LastStatusProviderCode : null,
                LastStatusProviderMessage = paymentComplementStamp != null ? paymentComplementStamp.LastStatusProviderMessage : null,
                CancellationStatus = paymentComplementCancellation != null ? paymentComplementCancellation.Status.ToString() : null,
                CancellationRequestedAtUtc = paymentComplementCancellation != null ? paymentComplementCancellation.RequestedAtUtc : null,
                CancellationCreatedAtUtc = paymentComplementCancellation != null ? paymentComplementCancellation.CreatedAtUtc : null,
