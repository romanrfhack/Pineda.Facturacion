...
public class ApplyProductFiscalProfileImportBatchResult
{
    public ApplyProductFiscalProfileImportBatchOutcome Outcome { get; set; }
    ...
    public IReadOnlyList<ApplyProductFiscalProfileImportBatchRowResult> Rows { get; init; } = [];
}
